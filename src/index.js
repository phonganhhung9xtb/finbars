...
FinBar.prototype = {
    ...
    scrollRealContent: function(idx) {
        var containerRect = this.content.parentElement.getBoundingClientRect(),
            ...
            maxScroll = Math.max(0, (this.content[sizeProp] || this.contentSize) - containerRect[sizeProp]),
            //scroll = Math.min(idx, maxScroll);
            scroll = (idx - this._min) / (this._max - this._min) * maxScroll;
        console.log('scroll: ' + scroll);
        this.onchange2.call(this, Math.round(scroll));
...
var handlersToBeBound = {
    ...
    onwheel: function(evt) {
        ...
        // console.log('YOLO: ', `${this.orientation} ${this.index}`)
        // this._setScroll(this.index);
        evt.stopPropagation();
        evt.preventDefault();
    },
